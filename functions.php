...
register_sidebar(array('name'=> __('DockCenter', 'natejones-digital-signage'),
		  'id' => 'DockCenter',
		  'description' => __( 'Recommended use: calendar events or RSS feed','natejones-digital-signage'),
          'before_widget' => '<div>',
          'after_widget' => '</div>',
          'before_title' => '<h3>',
          'after_title' => '</h3>',
